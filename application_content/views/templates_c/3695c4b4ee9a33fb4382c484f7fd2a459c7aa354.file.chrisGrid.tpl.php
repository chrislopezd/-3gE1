<?php /* Smarty version Smarty-3.1.13, created on 2016-05-20 05:19:22
         compiled from "application_content\views\templates\chrisGrid.tpl" */ ?>
<?php /*%%SmartyHeaderCode:25672573e823a70cd11-60135840%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3695c4b4ee9a33fb4382c484f7fd2a459c7aa354' => 
    array (
      0 => 'application_content\\views\\templates\\chrisGrid.tpl',
      1 => 1463714273,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '25672573e823a70cd11-60135840',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_573e823a77d0a8_94490163',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_573e823a77d0a8_94490163')) {function content_573e823a77d0a8_94490163($_smarty_tpl) {?>
<!DOCTYPE html>
			...
			<section id="right-content">
				...
				<section id="right-content-wrapper">
					...
					<section class="page-content">
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Stacked-to-horizontal</h2>
							...
							<div class="col-lg-12">
								<h4>Examples:</h4>
								<div class="row">
									<div class="col-md-1"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-1</header></div></div></div>
									<div class="col-md-1"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-1</header></div></div></div>
									<div class="col-md-1"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-1</header></div></div></div>
									<div class="col-md-1"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-1</header></div></div></div>
									<div class="col-md-1"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-1</header></div></div></div>
								...
								<div class="row">
									<div class="col-md-8"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-8</header></div></div></div>
									<div class="col-md-4"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-4</header></div></div></div>
								</div>
								<div class="row">
									<div class="col-md-4"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-4</header></div></div></div>
									<div class="col-md-4"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-4</header></div></div></div>
								...
								<div class="row">
									<div class="col-md-6"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-6</header></div></div></div>
									<div class="col-md-6"><div class="panel panel-default"><div class="panel-heading"><header>.col-md-6</header></div></div></div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<h2 class="text-primary">Mobile and desktop</h2>
							...
							<div class="col-lg-12">
								...
								<div class="row">
									<div class="col-xs-12 col-md-8"><div class="panel panel-default"><div class="panel-heading"><header>.col-xs-12 .col-md-8</header></div></div></div>
									<div class="col-xs-6 col-md-4"><div class="panel panel-default"><div class="panel-heading"><header>.col-xs-6 .col-md-4</header></div></div></div>
								</div>
								...
								<div class="row">
									<div class="col-xs-6"><div class="panel panel-default"><div class="panel-heading"><header>.col-xs-6</header></div></div></div>
									<div class="col-xs-6"><div class="panel panel-default"><div class="panel-heading"><header>.col-xs-6</header></div></div></div>
								</div>
							</div>
						</div>
