<?php /* Smarty version Smarty-3.1.13, created on 2016-08-23 10:33:46
         compiled from "application_content\views\templates\formulario.tpl" */ ?>
<?php /*%%SmartyHeaderCode:9305741f78460dd08-15709582%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'be62f8d7f8c9d3429f096ac2eb6ed27c1691d1cd' => 
    array (
      0 => 'application_content\\views\\templates\\formulario.tpl',
      1 => 1471966187,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '9305741f78460dd08-15709582',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_5741f784659a84_75498416',
  'variables' => 
  array (
    'edit' => 0,
    'perfil' => 0,
...
<?php if ($_valid && !is_callable('content_5741f784659a84_75498416')) {function content_5741f784659a84_75498416($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("design/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
" readonly />
						...
						<?php if ($_smarty_tpl->tpl_vars['estatus']->value==3||$_smarty_tpl->tpl_vars['estatus']->value==4){?>
						<div class="form-group floating-label col-md-12">
...
" maxlength="10" autocomplete="off">
													...
													<td class="td"><button type="button" name="deleted[]" class="btn btn-danger deleteTrFirst" style="min-
													width:30px"><i class="fa fa-times" title="Eliminar fila"></i></button></td>
													<?php }?>
													...
													<td>
													<button type="button" name="success[]" class="btn btn-success" style="min-width:20px;cursor:default;"><i
													 class="fa fa-check-square-o" title="Validado"></i></button></td>
													<?php }?>
													<?php if ($_smarty_tpl->tpl_vars['perfil']->value>1&&$_smarty_tpl->tpl_vars['estatus']->value>1){?>
													...
													<td><div class="list-icon">
														<?php if ($_smarty_tpl->tpl_vars['estatus']->value==3||$_smarty_tpl->tpl_vars['estatus']->value==4){?>
															<ul class="list">
																<?php if ($_smarty_tpl->tpl_vars['p']->value['estatusCan']==3){?>
...
" data-tipo="can" value="<?php echo $_smarty_tpl->tpl_vars['p']->value['estatusCan'];?>
" />
														<?php }?>
														</div>
													</td>
...
" maxlength="10" autocomplete="off">
													...
													<td><div class="list-icon">
															<?php if ($_smarty_tpl->tpl_vars['estatus']->value==3||$_smarty_tpl->tpl_vars['estatus']->value==4){?>
															<ul class="list">
																<?php if ($_smarty_tpl->tpl_vars['pc']->value['estatusCrea']==3){?>
																<li><i class="fa fa-check-square" aria-hidden="true" style="color:#009688;font-size:11pt;"></i></li>
																<?php }else{ ?>
																<li><i class="fa fa-ban" aria-hidden="true" style="color:#F22314;font-size:11pt;"></i></li>
																<?php }?>
...
" data-tipo="crea" value="<?php echo $_smarty_tpl->tpl_vars['pc']->value['estatusCrea'];?>
" />
															<?php }?>
														</div>
													</td>
