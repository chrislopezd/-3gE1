        ...
        <table>
            ...
            <th style="width: 15%">
                <div class="form-group label-floating is-empty has-success">
                    <input type="text" class="form-control upper" placeholder="Clave CT" disabled>
                </div>
            </th>
            <th style="width: 25%">
                <div class="form-group label-floating is-empty has-success">
                    <input type="text" class="form-control upper" placeholder="Nombre CT" disabled>
                </div>
            </th>
            <th style="width: 10%">
                <div class="form-group label-floating is-empty has-success">
                    <input type="text" class="form-control upper" placeholder="ZONA" disabled>
                </div>
            </th>
             <th style="width: 20%">
                <div class="form-group label-floating is-empty has-success">
                    <input type="text" class="form-control upper" placeholder="Municipio" disabled>
                </div>
            </th>
             <th style="width: 20%">
                <div class="form-group label-floating is-empty has-success">
                    <input type="text" class="form-control upper" placeholder="Localidad" disabled>
                </div>
            </th>
            </tr>
        </table>
        <div class="bg tablescroll">
            <table class="table table-bordered table-striped">
                ...
                <tr>
                    ...
                    <td style="width: 15%">{$v['CLAVECCT']}</th>
                    <td style="width: 25%">{$v['NOMBRECT']}</th>
                    <td style="width: 10%">{$v['zona']}</th>
                    <td style="width: 20%">{$v['municipio']}</th>
