...
;$(function(){
	...
	var AppFeatures = {
		...
		appBackground: function(){
			if ($.appBackgroundImage) {
				var style = {
					"background-image":"url(img/pattern/" + $.appBackgroundImage +")",
	...
	var AppPreload = {
		...
		loadScripts: function(){
			...
			$LAB
			.script(
				"resources/js/sistema/bemat-config.js",
				"resources/js/sistema/bemat-circularLoader.js",
				"resources/js/sistema/bemat-components.js"
			)
			.wait(function(){
			...
			.script(
				...
				"resources/js/sistema/perfectscrollbar/perfect-scrollbar.jquery.min.js"
			...
			.wait(function(){
				...
				if ($.demoMode) {
					...
					$LAB.script("resources/js/sistema/bemat-admin-demo.js");
				}
